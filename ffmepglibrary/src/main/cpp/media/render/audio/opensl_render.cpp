...
OpenSLRender1::OpenSLRender1() = default;

OpenSLRender1::~OpenSLRender1() = default;

void OpenSLRender1::InitRender() {
    if (!CreateEngine()){
        return;
    }
...
bool OpenSLRender1::CreateEngine() {
...
bool OpenSLRender1::CreateOutputMixer() {
...
bool OpenSLRender1::ConfigPlayer() {
...
bool OpenSLRender1::CheckError(SLresult result, std::string hint) {
...
void OpenSLRender1::sRenderPcm(OpenSLRender1 *that){
    that->StartRender();
}

void OpenSLRender1::StartRender() {
...
void OpenSLRender1::sReadPcmBufferCbFun(SLAndroidSimpleBufferQueueItf bufferQueueItf, void *context) {
    OpenSLRender1 *player = (OpenSLRender1 *)context;
    player->BlockEnqueue();
}

void OpenSLRender1::BlockEnqueue() {
...
void OpenSLRender1::Render(uint8_t *pcm, int size) {
    if (m_pcm_player) {
...
void OpenSLRender1::ReleaseRender() {
    if (m_pcm_player){
